export const projects = [
  ...
  {
    name: "personal site",
    url: "https://github.com/charliethomson/thmsn.dev",
    liveUrl: "https://thmsn.dev",

    tools: ["vuejs", "typescript", "vercel"],
    description:
      "the site you're currently using, a place for me to store a bunch of information about myself and my projects.",
    learned: "work in progress :d",
  },
].map((_, id) => ({ ..._, id }));
